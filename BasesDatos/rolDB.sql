...
CREATE TABLE personajes (
                            ...
                            estado ENUM('vivo','muerto','descansando') DEFAULT 'vivo',
...
CREATE TABLE objetos (
                         ...
                         nombre VARCHAR(20) NOT NULL,
                         descripcion TEXT NOT NULL,
                         tipo ENUM('arma', 'armadura', 'pocion', 'otro') NOT NULL,
                         efecto TEXT,
...
CREATE TABLE misiones (
                          ...
                          tipo ENUM('principal', 'secundaria', 'diaria') DEFAULT 'secundaria',
...
CREATE TABLE progresoMisiones (
                                  idPersonaje INT,
                                  idMision INT,
                                  estado ENUM('aceptada', 'completada', 'fallada') DEFAULT 'aceptada',
